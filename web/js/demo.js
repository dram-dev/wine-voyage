...
import { producerEntry, resolveLocally } from './reference.js';
...
/** Offline lookup, backed by the same reference the server uses.
...
async function demoLookup(body) {
  ...
  return {
    ...
    bottlings,
    // Prices need live data, which offline cannot have.
    estimated_value: null,
    confidence: local.producer_match === 'exact' ? 0.85 : found ? 0.6 : 0,
